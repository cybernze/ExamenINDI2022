...
QT_MOC_LITERAL(1, 11, 16), // "enviaEstatCamera"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 9), // "girarRoda"
QT_MOC_LITERAL(4, 39, 5), // "atura"
QT_MOC_LITERAL(5, 45, 6), // "engega"
QT_MOC_LITERAL(6, 52, 9) // "setCamera"

    },
    "MyGLWidget\0enviaEstatCamera\0\0girarRoda\0"
    "atura\0engega\0setCamera"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->enviaEstatCamera((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->girarRoda(); break;
        case 2: _t->atura(); break;
        case 3: _t->engega(); break;
        case 4: _t->setCamera(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::enviaEstatCamera)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::enviaEstatCamera(bool _t1)
{
